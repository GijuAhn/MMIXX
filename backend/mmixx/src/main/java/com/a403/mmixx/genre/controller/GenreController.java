...
public class GenreController {
    ...
    @ApiOperation(value = "세부 장르 조회", notes = "장르의 세부 장르 리스트 가져오기 (가져올 장르 genre_seq)")
    @GetMapping("/{genreCategory}")
    public ResponseEntity<?> getGenreDetailList(@PathVariable("genreCategory") Integer genreCategory) {
        return null;
    }//getGenreList
