...
class MusicAPIView(APIView):
    def get(self, request):
        ...
        checkpoint_path = './music/model/checkpoints/style/jamendo/autodiff/lightning_logs/version_0/checkpoints/epoch=362-step=1210241-val-jamendo-autodiff.ckpt'
        args = ["python", "./music/model/scripts/process.py", "-i", "./music/model/examples/TeddyBear.wav", "-r", "./music/model/examples/Aves.wav", "-c", checkpoint_path]
